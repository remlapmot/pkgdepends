...
```
    ...
    #> 1 /tmp/RtmpGWDY… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #> ✔ Packaged pkgconfig 2.0.2 (532ms)                                              
    #> ℹ Building pkgconfig 2.0.2                                                      
    #> ✔ Built pkgconfig 2.0.2 (920ms)                                                 
    #> ✔ Installed pkgconfig 2.0.2 (github::cran/pkgconfig@d892880) (19ms)             
    #> ✔ Summary:   1 new  in 938ms                                                    
    #> # A data frame: 1 × 32                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/RtmpGWDY… pkgcon… Priv… 2.0.2   MIT + … utils   covr, t… FALSE           
