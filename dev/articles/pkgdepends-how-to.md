...
```
    ...
    #> ✔ Summary:   1 new  in 875ms                                                    
    #> # A data frame: 1 × 31                                                          
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/Rtmp3Gmf… pkgcon… Priv… 2.0.3   MIT + … utils   covr, t… FALSE           
...
```
    ...
    #>   library        package title version license imports suggests needscompilation
    #>   <chr>          <chr>   <chr> <chr>   <chr>   <chr>   <chr>    <lgl>           
    #> 1 /tmp/Rtmp3Gmf… pkgcon… Priv… 2.0.2   MIT + … utils   covr, t… FALSE           
